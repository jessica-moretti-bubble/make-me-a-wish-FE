<template>
    <AuthFormWrapper>
        ...
        <SignupFormHeader />
        <div class="w-full flex justify-center items-center flex-col gap-y-4 mb-8">
            <GenericButton label="Continua con Google" variant="whiteOutline" icon-name="logos:google-icon"
                @click="googleLogin">
                <Icon name="logos:google-icon" style="scale: 1" />
            </GenericButton>
            <p class="uppercase text-[#9CA3AF]">Oppure</p>
        ...
        <form class="w-full" @submit.prevent="onSubmit">
            ...
            <div class="flex justify-center items-center flex-col gap-y-6 mb-8">
                ...
                <GenericInput label="Conferma password" type="password" icon-name="bxs:lock" placeholder="••••••••••"
            ...
            <div class="gap-y-6 flex justify-center items-center flex-col">
                ...
                <p>
                    Hai già un account?
                    <NuxtLink to="/" class="text-[#4F46E5] hover:underline font-medium">
                        Accedi
                    </NuxtLink>
                </p>
            </div>
...
import SignupFormHeader from './SignupFormHeader.vue'
