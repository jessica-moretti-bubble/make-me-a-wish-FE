...
<template>
    <div class="flex flex-col gap-y-6">
        <p class="font-semibold">Immagine custom</p>

        <div class="py-8 border-3 border-dotted border-gray-400 flex flex-col justify-center items-center gap-2">
            <div class="size-[48px] rounded-xl flex justify-center items-center bg-gray-200">
            ...
            <div class="flex flex-col gap-y-4 mt-2">
                ...
                <GenericButton v-if="fileExist" label="Rimuovi file" @click="handleRemoveImage" />
            </div>
        </div>
    </div>
</template>
